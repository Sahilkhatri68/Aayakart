...
export default function Checkout() {
    return (
        <>
            ...
            <div><main className="main checkout">
                {/* Start of Breadcrumb */}
                        ...
                        <form className="form checkout-form" action="#" method="post">
                            <div className="row mb-9">
                                ...
                                <div className="col-lg-5 mb-4 sticky-sidebar-wrapper">
                                    <div className="pin-wrapper" style={{ height: "898.969px" }}>
                                        <div
                                                    ...
                                                    <tbody>
                                                        <tr className="bb-no">
                                                            <td className="product-name">
                                                                Palm Print Jacket <i className="fas fa-times" />{" "}
                                                        ...
                                                        <tr className="bb-no">
                                                            <td className="product-name">
                                                                Brown Backpack <i className="fas fa-times" />
                                                                <span className="product-quantity">1</span>
                                                            </td>
