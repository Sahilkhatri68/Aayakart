                    ...
                    <div className="container">
                        ...
                        <div className="sub-orders mb-10">
                            ...
                            <div className="alert alert-icon alert-inline mb-5">
                                ...
                                <strong>Note: </strong>This order has products from multiple vendors.
                                So we divided this order into multiple vendor orders. Each order will
                                be handled by their respective vendor independently.
                            </div>
